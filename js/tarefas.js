...
let janelaEdicaoBtnFechar = docu - ment.querySelector('#janelaEdicaoBtnFechar');
let btnAtualizarTarefa = docu - ment.querySelector('#btnAtualizarTarefa');
let idTarefaEdicao = document.querySelector('#idTarefaEdicao');
let inputTarefaNomeEdicao = docu - ment.querySelector('#inputTarefaNomeEdicao');
